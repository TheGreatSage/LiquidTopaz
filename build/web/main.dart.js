...
for(z=0;z<16;z=y)for(y=z+1,x=0;x<C.y[z].length;++x){w=C.S[z]
if(x>=w.length)return H.d(w,x)
v=C.W.h(0,w[x])
w=C.y[z]
if(x>=w.length)return H.d(w,x)
a.aE(x+4,y,w[x],v)}a.bp(25,18,"Which hero shall you play?")
a.aE(0,a.gk(a)-1,"[L] Select a hero, [?] Change selection, [N] Create a new hero, [D] Delete hero",C.i)
w=this.c.b
if(w.length===0)a.aE(25,20,"(No heroes. Please create a new one.)",C.i)
for(u=0;u<w.length;++u){t=w[u]
if(u===this.d){s=C.e
r=C.j}else{s=C.h
r=C.e}a.ar(26,20+u,t.a,s,r)}},
...
C.y=I.L(["______   ______                          ______        _____        ","\\ .  /   \\  . /                          \\  . /        \\ . |         "," | .|     |. |                            |. |          | .|     "," |. |     | .|   ___________ _____  ____  | .|   ______ |. |        "," |:::     |::|  /:::::::::::|\\:::|  \\:::| |::|  /::::::\\|::|            "," |xx|     |xx|  |xx|     |xx| |xx|   |xx| |xx| /xx/     |xx|             "," |xx|     |xx|  |xx|     |XX| |xx|   |xx| |xx| |xx|     |xx|        "," |XX|     |XX|  |XX|     |XX| |XX\\___|XX| |XX| |XXX\\____|XX|          "," |XX|    /XXXX\\ \\XXXXXXXXXXX| \\XXXX/|XXX\\/XXXX\\ \\XXXXXX/\\XXX\\         "," |XX|  __________________|XX|______________________________________"," |XX| |XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\\"," |XX|                    |XX|_"," |XX|                    |XXX/"," |XXX\\                   |XX/"," |XXXX\\\\.__.//XX\\\\       |X/  ","/XXXXXXXXXXXXXXxx\\\\      |/"])
