...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    stringContainsUnchecked: function(receiver, other, startIndex) {
      ...
      if (typeof other === "string")
        ...
        substr = C.JSString_methods.substring$1(receiver, startIndex);
        other.toString;
        H.checkString(substr);
        H.checkInt(0);
        return H.allMatchesInStringUnchecked(other, substr, 0).length !== 0;
      }
    },
    ConstantMap: {
      "^": "Object;",
    ...
    }, "call$1", "convert___defaultToEncodable$closure", 2, 0, 19],
    _JsonMap: {
    ...
    _ValidatingTreeSanitizer_sanitizeTree_walk: {
      "^": "Closure:16;_html$_captured_this_0",
  ...
  }], ["liquid.bb.math.darray", "package:liquid/src/backbone/math/array2d.dart",, M, {
    "^": "",
    Array2D: {
      "^": "IterableBase;width,height,_elements",
      $index: function(_, pos) {
        var t1, t2;
        t1 = this._elements;
        t2 = J.getInterceptor$x(pos);
        t2 = t2.get$y(pos).$mul(0, this.width).$add(0, t2.get$x(pos));
      ...
      $indexSet: function(_, pos, value) {
        var t1, t2;
        t1 = this._elements;
        t2 = C.JSInt_methods.get$y(pos).$mul(0, this.width).$add(0, C.JSInt_methods.get$x(pos));
        if (t2 >>> 0 !== t2 || t2 >= t1.length)
          return H.ioore(t1, t2);
        t1[t2] = value;
      },
      ...
      static: {Array2D$: function(width, height, value, $T) {
          return H.setRuntimeTypeInfo(new M.Array2D(width, height, P.List_List$filled(width * height, value, $T)), [$T]);
        }}
    }
  }], ["liquid.bb.math.rng", "package:liquid/src/backbone/math/rng.dart",, A, {
    "^": "",
    Rng: {
      "^": "Object;_random",
  ...
  }], ["liquid.bb.term.canvas_terminal", "package:liquid/src/backbone/terminals/canvas_terminal.dart",, A, {
    "^": "",
    CanvasTerminal: {
      "^": "RenderableTerminal;_display,_font,_canvas,_context,_scale",
      get$width: function(_) {
        return this._display._glyphs.width;
      },
      get$height: function(_) {
        return this._display._glyphs.height;
      },
      ...
      render$0: function() {
        var t1 = this._font;
        this._context.font = "" + t1.charWidth * this._scale + "px " + t1.family + ", sans-serif";
        this._display.render$1(new A.CanvasTerminal_render_closure(this));
      },
      CanvasTerminal$4: function(width, height, _canvas, _font) {
        var t1, t2, t3, t4;
        t1 = this._canvas;
        this._context = J.get$context2D$x(t1);
        t2 = this._font;
        t3 = t2.charWidth * width;
        t1.width = t3;
        t2 = t2.lineHeight * height;
        t1.height = t2;
        ...
        if (t4 > 1) {
          ...
          t4.width = t3;
          t1 = t1.style;
          t2 = H.S(t2 / this._scale) + "px";
          t1.height = t2;
        }
      },
      static: {CanvasTerminal$: function(width, height, _canvas, _font) {
          var t1 = new A.CanvasTerminal(new G.Display(M.Array2D$(width, height, null, E.Glyph), M.Array2D$(width, height, C.Glyph_oqh, E.Glyph)), _font, _canvas, null, 1);
          t1.CanvasTerminal$4(width, height, _canvas, _font);
          return t1;
        }}
    },
    CanvasTerminal_render_closure: {
      "^": "Closure:17;_canvas_terminal$_captured_this_0",
      call$3: function(x, y, glyph) {
        var $char, t1, t2, t3, t4, t5, t6, t7;
        $char = glyph.get$$char();
        t1 = this._canvas_terminal$_captured_this_0;
        t2 = t1._context;
        t2.fillStyle = glyph.back.cssColor;
        t3 = t1._font;
        t4 = t3.charWidth;
        t5 = x * t4;
        t6 = t3.lineHeight;
        t7 = y * t6;
        t2.fillRect(t5, t7, t4, t6);
        if ($char === 0 || $char === 32)
          return;
        t1 = t1._context;
        t1.fillStyle = glyph.fore.cssColor;
        t2 = P.String_String$fromCharCodes([$char], 0, null);
        t1.toString;
        t1.fillText(t2, t5 + t3.x, t7 + t3.y);
      }
    },
    Font: {
      "^": "Object;family,size,charWidth,lineHeight,x,y"
    }
  }], ["liquid.bb.term.display", "package:liquid/src/backbone/terminals/display.dart",, G, {
    "^": "",
    Display: {
      ...
      render$1: function(renderGlyph) {
        var t1, t2, t3, t4, t5, t6, t7, y, t8, t9, x, t10, glyph, t11;
        for (t1 = this._glyphs, t2 = t1.height, t3 = t1.width, t1 = t1._elements, t4 = t1.length, t5 = this._changedGlyphs, t6 = t5._elements, t5 = t5.width, t7 = t6.length, y = 0; y < t2; ++y)
          for (t8 = y * t3, t9 = y * t5, x = 0; x < t3; ++x) {
            t10 = t9 + x;
            if (t10 >= t7)
  ...
  }], ["liquid.bb.term.glyph", "package:liquid/src/backbone/terminals/glyph.dart",, E, {
    "^": "",
    Color: {
      "^": "Object;cssColor"
    },
    Glyph: {
      ...
      $eq: function(_, other) {
        if (other == null)
          return false;
        if (!(other instanceof E.Glyph))
          return false;
        return this.$char === other.$char && this.fore === other.fore && this.back === other.back;
      }
    }
  }], ["liquid.bb.term.key_bindings", "package:liquid/src/backbone/terminals/key_bindings.dart",, K, {
    "^": "",
    KeyBindings: {
      "^": "Object;_bindings",
      bind$4$alt$shift: function(input, keyCode, alt, shift) {
        this._bindings.$indexSet(0, new K._KeyBinding(keyCode, false, false), input);
      },
    ...
    _KeyBinding: {
      ...
      $eq: function(_, other) {
        ...
        if (other == null)
          return false;
        if (!(other instanceof K._KeyBinding))
          return false;
        t1 = this.charCode;
        t2 = other.charCode;
  ...
  }], ["liquid.bb.term.terminal", "package:liquid/src/backbone/terminals/terminal.dart",, X, {
    "^": "",
    Terminal: {
      "^": "Object;",
      clear$0: function(_) {
        var y, x;
        for (y = 0; y < this.get$height(this); ++y)
          for (x = 0; x < this.get$width(this); ++x)
            this.drawGlyph$3(x, y, C.Glyph_oqh);
      },
      writeAt$5: function(x, y, text, fore, $back) {
        ...
        while (true) {
          ...
          if (!(i < t4))
            break;
          t4 = x + i;
          if (t4 >= this.get$width(this))
            break;
          t5 = C.JSString_methods.codeUnitAt$1(t1.get$codeUnits(text)._string, i);
          t6 = t3 ? fore : C.Color_Uxn;
          this.drawGlyph$3(t4, y, new E.Glyph(t5, t6, t2 ? $back : C.Color_oyU));
          ++i;
        }
      },
  ...
  }], ["liquid.bb.term.user_interface", "package:liquid/src/backbone/terminals/user_interface.dart",, N, {
    "^": "",
    UserInterface: {
      "^": "Object;keyBindings,_screens,_terminal,_dirty",
      refresh$0: function() {
        var t1, t2, _i;
      ...
      _keyDown$1: [function($event) {
        var $screen, keyCode, shift, alt, input, t1;
        ...
        if (alt == null)
          alt = false;
        input = this.keyBindings._bindings.$index(0, new K._KeyBinding(keyCode, shift, alt));
        if (input != null) {
        ...
        if ($screen.keyDown$3$alt$shift(keyCode, $event.altKey, t1))
          $event.preventDefault();
      }, "call$1", "get$_keyDown", 2, 0, 18],
      _render$0: function() {
        var t1, i, t2;
        J.clear$0$ax(this._terminal);
        for (t1 = this._screens, i = t1.length - 1, t2 = i >= 0; t2;)
          break;
        if (i < 0)
          i = 0;
  ...
  }], ["liquid.content", "package:liquid/src/content/content.dart",, Y, {
    "^": "",
    GameContent: {
      "^": "Object;"
    }
  }], ["liquid.engine.player.player", "package:liquid/src/engine/player/player.dart",, T, {
    "^": "",
    PlayerInfo: {
      "^": "Object;name,level"
    }
  }], ["liquid.ui.Hero_Creation_Screen", "package:liquid/src/ui/Hero_Creation_Screen.dart",, K, {
    "^": "",
    HeroCreation: {
      "^": "Screen;content,storage,defaultName,name,_ui",
      keyDown$3$alt$shift: function(keyCode, alt, shift) {
        var t1, t2, t3, t4, charCode;
        switch (keyCode) {
          case 13:
            t1 = this.name;
            if (t1.length === 0)
              t1 = this.defaultName;
            t2 = this.storage;
            t2.heroes.push(new T.PlayerInfo(t1, 1));
            t2.save$0(0);
            t2 = this._ui;
            t1 = this.content;
            t3 = new K.Storage(t1, H.setRuntimeTypeInfo([], [T.PlayerInfo]));
            t3._load$0();
            t3 = new E.MainMenuScreen(t1, t3, 0, null);
            t1 = t2._screens;
            if (0 >= t1.length)
              return H.ioore(t1, 0);
            t1.pop()._ui = null;
          ...
          case 8:
            ...
            if (t2 > 0) {
              ...
              this.name = t1;
              if (t1.length === 0) {
                t1 = $.$get$rng().range$1(4);
                if (t1 < 0 || t1 >= 4)
                  return H.ioore(C.List_ChT, t1);
                this.defaultName = C.List_ChT[t1];
              }
              this.dirty$0();
            }
            break;
          ...
          default:
            ...
            if (keyCode >= 65 && keyCode <= 90) {
              charCode = shift !== true ? 32 + keyCode : keyCode;
              this.name = this.name + P.String_String$fromCharCodes([charCode], 0, null);
              this.dirty$0();
            } else if (keyCode >= 48 && keyCode <= 57) {
              this.name = this.name + P.String_String$fromCharCodes([keyCode], 0, null);
              this.dirty$0();
            }
            break;
        }
      ...
      render$1: function(terminal) {
        var t1, t2;
        t1 = J.getInterceptor$ax(terminal);
        t1.clear$0(terminal);
        terminal.writeAt$3(0, 0, "What name shall the bards use to sing of your hero's adventures?");
        t2 = this.name;
        if (t2.length === 0)
          terminal.writeAt$5(0, 2, this.defaultName, C.Color_oyU, C.Color_uUr);
        else {
          terminal.writeAt$3(0, 2, t2);
          terminal.writeAt$5(this.name.length, 2, " ", C.Color_oyU, C.Color_uUr);
        }
        terminal.writeAt$4(0, t1.get$height(terminal) - 1, "[A-Z] Enter name, [Del] Delete letter, [Enter] Create hero, [Esc] Cancel", C.Color_uIT);
        this.dirty$0();
      }
    }
  }], ["liquid.ui.input", "package:liquid/src/ui/input.dart",, K, {
    "^": "",
    Input: {
      "^": "Object;name"
    }
  }], ["liquid.ui.main_menu_screen", "package:liquid/src/ui/main_menu_screen.dart",, E, {
    "^": "",
    MainMenuScreen: {
      "^": "Screen;content,storage,selectedHero,_ui",
      handleInput$1: function(input) {
        switch (input) {
          case C.Input_UP:
      ...
      keyDown$3$alt$shift: function(keyCode, alt, shift) {
        ...
        switch (keyCode) {
          case 78:
            t1 = this._ui;
            t2 = $.$get$rng().range$1(4);
            if (t2 < 0 || t2 >= 4)
              return H.ioore(C.List_ChT, t2);
            t2 = new K.HeroCreation(this.content, this.storage, C.List_ChT[t2], "", null);
            t1.toString;
            t2._ui = t1;
            t1._screens.push(t2);
            t1._render$0();
      ...
      render$1: function(terminal) {
        var y, y0, x, t1, color, i, hero, fore, $back;
        this.dirty$0();
        for (y = 0; y < 28; y = y0)
          for (y0 = y + 1, x = 0; x < C.List_Qug[y].length; ++x) {
            t1 = C.List_UAS[y];
            if (x >= t1.length)
              return H.ioore(t1, x);
            color = C.Map_cmMys.$index(0, t1[x]);
            t1 = C.List_Qug[y];
            if (x >= t1.length)
              return H.ioore(t1, x);
            terminal.writeAt$4(x + 4, y0, t1[x], color);
          }
        this.dirty$0();
        terminal.writeAt$3(10, 18, "Which hero shall you play?");
        terminal.writeAt$4(0, terminal.get$height(terminal) - 1, "[L] Select a hero, [?] Change selection, [N] Create a new hero, [D] Delete hero", C.Color_uIT);
        t1 = this.storage.heroes;
        if (t1.length === 0)
          terminal.writeAt$4(10, 20, "(No heroes. Please create a new one.)", C.Color_uIT);
        for (i = 0; i < t1.length; ++i) {
          ...
          terminal.writeAt$5(11, 20 + i, hero.name, fore, $back);
        }
      },
  ...
  }], ["liquid.ui.storage", "package:liquid/src/ui/storage.dart",, K, {
    "^": "",
    Storage: {
      ...
      _load$0: function() {
        ...
        if (storage == null)
          return;
        for (t1 = J.get$iterator$ax(J.$index$asx(C.JsonCodec_null_null.decode$1(storage), "heroes")), t2 = this.heroes; t1.moveNext$0();)
          t2.push(new T.PlayerInfo(J.$index$asx(t1.get$current(), "name"), 1));
      },
      save$0: function(_) {
        var heroData, t1, t2, _i, data;
        heroData = [];
        for (t1 = this.heroes, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          heroData.push(P.LinkedHashMap__makeLiteral(["name", t1[_i].name]));
        data = P.LinkedHashMap__makeLiteral(["heroes", heroData]);
        window.localStorage.setItem("heroes", C.JsonCodec_null_null.encode$1(data));
        P.print("Saved.");
      }
    }
  }], ["liquid.web.main", "main.dart",, R, {
    "^": "",
    addTerminal: function($name, element, terminalCallback) {
      var terminal, button, t1;
      terminal = terminalCallback.call$1(element);
      $.$get$terminals().push([$name, element, terminal]);
      button = document.createElement("button", null);
      t1 = J.getInterceptor$x(button);
      t1.set$innerHtml(button, $name);
      t1 = t1.get$onClick(button);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.addTerminal_closure($name, terminal)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      J.get$children$x(document.querySelector(".button-bar")).add$1(0, button);
    },
    main: [function() {
      var $content, font, fontIndex, i, t1, t2, t3;
      $content = new Y.GameContent();
      R.addTerminal("Arial", W.CanvasElement_CanvasElement(null, null), new R.main_closure());
      R.addTerminal("Helvetica", W.CanvasElement_CanvasElement(null, null), new R.main_closure0());
      font = window.localStorage.getItem("fonts");
      i = 0;
      while (true) {
        t1 = $.$get$terminals();
        if (!(i < t1.length)) {
      ...
      if (fontIndex >= t1.length)
        return H.ioore(t1, fontIndex);
      t2.appendChild(t1[fontIndex][1]);
      if (fontIndex >= t1.length)
        return H.ioore(t1, fontIndex);
      t1 = t1[fontIndex][2];
      t2 = new K.KeyBindings(P.LinkedHashMap_LinkedHashMap(null, null, null, K._KeyBinding, P.Object));
      t1 = new N.UserInterface(t2, H.setRuntimeTypeInfo([], [N.Screen]), t1, null);
      t3 = document.body;
      t3.toString;
      t3 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t3, "keydown", false), [null]);
      ...
      $.ui = t1;
      t2.bind$2(C.Input_OK, 13);
      $.ui.keyBindings.bind$2(C.Input_CANCEL, 27);
      $.ui.keyBindings.bind$2(C.Input_UP, 87);
      $.ui.keyBindings.bind$2(C.Input_DOWN, 83);
      t2 = $.ui;
      t1 = new K.Storage($content, H.setRuntimeTypeInfo([], [T.PlayerInfo]));
      t1._load$0();
      t1 = new E.MainMenuScreen($content, t1, 0, null);
      t2.toString;
      t1._ui = t2;
      t2._screens.push(t1);
      t2._render$0();
      ...
      C.Window_methods._requestAnimationFrame$1(t2, W._wrapZone(new R.main_tick()));
    }, "call$0", "main__main$closure", 0, 0, 1],
    addTerminal_closure: {
      "^": "Closure:0;_captured_name_0,_captured_terminal_1",
      call$1: function(_) {
        var t1, i, t2, t3;
        for (t1 = this._captured_name_0, i = 0; t2 = $.$get$terminals(), i < t2.length; ++i)
          if (J.$eq$(t2[i][0], t1)) {
            t3 = document.querySelector("#game");
            if (i >= t2.length)
              return H.ioore(t2, i);
            t3.appendChild(t2[i][1]);
          } else {
            if (i >= t2.length)
              return H.ioore(t2, i);
            J.remove$0$ax(t2[i][1]);
          }
        t2 = $.ui;
        t2._terminal = this._captured_terminal_1;
        t2._dirty = true;
        window.localStorage.setItem("fonts", t1);
      }
    },
    main_closure: {
      "^": "Closure:0;",
      call$1: function(element) {
        return A.CanvasTerminal$(100, 40, element, new A.Font("Arial", 12, 9, 13, 1, 21));
      }
    },
    main_closure0: {
      "^": "Closure:0;",
      call$1: function(element) {
        return A.CanvasTerminal$(100, 40, element, new A.Font("Helvetica", 24, 9, 13, 1, 21));
      }
    },
    main_tick: {
      "^": "Closure:0;",
  ...
  C.Color_Uxn = new E.Color("#fff");
  C.Color_oyU = new E.Color("#000");
  C.Color_uIT = new E.Color("rgb(128, 128, 128)");
  C.Color_uUr = new E.Color("rgb(255, 255, 0)");
  C.Duration_0 = new P.Duration(0);
  C.Glyph_oqh = new E.Glyph(32, C.Color_Uxn, C.Color_oyU);
  C.Input_CANCEL = new K.Input("CANCEL");
  C.Input_DOWN = new K.Input("DOWN");
  C.Input_OK = new K.Input("OK");
  C.Input_UP = new K.Input("UP");
  ...
  C.List_ChT = Isolate.makeConstantList(["Sage", "Sage Martin", "Sage is God", "Sage is The Holy Creator"]);
  C.List_Qug = Isolate.makeConstantList(["______   ______                          ______        _____        ", "\\ .  /   \\  . /                          \\  . /        \\ . |         ", " | .|     |. |                            |. |          | .|     ", " |. |     | .|   ___________ _____  ____  | .|   ______ |. |        ", " |:::     |::|  /:::::::::::|\\:::|  \\:::| |::|  /::::::\\|::|            ", " |xx|     |xx|  |xx|     |xx| |xx|   |xx| |xx| /xx/     |xx|             ", " |xx|     |xx|  |xx|     |XX| |xx|   |xx| |xx| |xx|     |xx|        ", " |XX|     |XX|  |XX|     |XX| |XX\\___|XX| |XX| |XXX\\____|XX|          ", " |XX|    /XXXX\\ \\XXXXXXXXXXX| \\XXXX/|XXX\\/XXXX\\ \\XXXXXX/\\XXX\\         ", " |XX|  __________________|XX|______________________________________", " |XX| |XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\\", " |XX|                    |XX|_ ____________________", " |XX|                    |XXX/ |XXXXXXXXXXXXXXXXXX|", " |XXX\\                   |XX/  |X/  /XXXXXXXX\\  \\x|  ", " |XXXX\\\\.__.//XX\\\\       |X/   |/      |XX|      \\|", "/XXXXXXXXXXXXXXxx\\\\      |/            |XX|   ___________   ___________    ________ _________", "                                       |XX|  /XXXXXXXXXXX\\ /XXXXXXXXXXX\\   \\XXXXXXX\\\\XXXXXXXX\\", "                                       |XX|  |XX|     |XX| |XX|     |XX|  _____ \\XX|  \\XX\\", "                                       |XX|  |XX|     |XX| |XX|     |XX| /XXXXX\\|XX|    \\XX\\", "                                       /XX\\  |XX|     |XX| |XX|     |XX||XX(____|XX|      \\XX\\", "                                      /XXXX\\ \\XXXXXXXXXXX/ |XXXXXXXXXXX/ \\XXXXXX/\\XX\\/XXXXXXXX/           ", "                               ____________________________|XX|________________________________            ", "                              |XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\\                    ", "                                                           |XX|_", "                                                           |XXX/", "                                                           |XX/", "                                                           |X/", "                                                           |/"]);
  C.List_UAS = Isolate.makeConstantList(["RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRL", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRL", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRL", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRL", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRL", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRL", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRL", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRL", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRL", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR ", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRL", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR ", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRL", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR ", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR", "RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR"]);
  ...
  C.List_cmY = Isolate.makeConstantList(["L", "E", "R", "O", "G", "Y"]);
  C.Color_WGE = new E.Color("rgb(192, 192, 192)");
  C.Color_A0t = new E.Color("rgb(220, 0, 0)");
  C.Color_M5w = new E.Color("rgb(255, 128, 0)");
  C.Color_DV7 = new E.Color("rgb(255, 192, 0)");
  C.Map_cmMys = new H.ConstantStringMap(6, {L: C.Color_WGE, E: C.Color_uIT, R: C.Color_A0t, O: C.Color_M5w, G: C.Color_DV7, Y: C.Color_uUr}, C.List_cmY);
  ...
  }, "rng", "$get$rng", "rng", function() {
    var t1 = Date.now();
    return new A.Rng(P._Random$(t1));
  }, "terminals", "$get$terminals", "terminals", function() {
    return [];
  }]);
  Isolate = Isolate.$finishIsolateConstructor(Isolate);
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, void: true}, {func: 1, void: true, args: [{func: 1, void: true}]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [,,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.bool}, {func: 1, args: [, P.StackTrace]}, {func: 1, void: true, args: [, P.StackTrace]}, {func: 1, args: [P.Symbol,,]}, {func: 1, void: true, args: [W.Node, W.Node]}, {func: 1, args: [,,,]}, {func: 1, void: true, args: [W.KeyEvent]}, {func: 1, ret: P.Object, args: [,]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(R.main__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(R.main__main$closure(), a);
